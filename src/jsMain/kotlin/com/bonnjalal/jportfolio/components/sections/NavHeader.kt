package com.bonnjalal.jportfolio.components.sections
...
val BrandStyle = ComponentStyle("brand") {
    val linkColor = colorMode.toSilkPalette().background
...
@Composable
private fun Brand(text: String) {
    Link("/", text, BrandStyle.toModifier(), UndecoratedLinkVariant)
}
@Composable
fun NavHeader() {
